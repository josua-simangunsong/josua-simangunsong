...
<html lang="en">
  ...
  <body>
  <div class="jumbotron">
        <h1 class="display-4" style="text-align:center;">Berhasil</h1>
        <p class="lead"style="text-align:center;" >Input Data Telah Berhasil</p>
    </div>
    <!-- tombol kembali -->
    <div class ="row justify-content-center">
    <a href="#" class="btn btn-info btn-lg" onclick="kembali()">
    <span class="glyphicon glyphicon-log-out"></span> Kembali Ke Layar Utama
    </a>
    </div>
    <!-- Optional JavaScript -->
